...
const faqItems = [
  {
    question: "Is my crypto safe with Studio?",
    answer: "Absolutely. Studio is completely read-only. We never ask for your private keys, seed phrases, or require smart contract signature authority. Your assets remain secure in your wallets; we only aggregate and display public blockchain data."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Studio aggregates liquidity from major decentralized exchange routes (such as 1inch, Uniswap, and Jupiter) to deliver zero-slippage swaps directly from your connected wallets."
  }
];
      ...
      <nav className="fixed w-full z-50 top-0 border-b border-white/5 bg-[#030303]/70 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            {/* Visual Spiral Logo */}
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#ff5722] to-[#ff2b06] flex items-center justify-center shadow-[0_0_15px_rgba(255,79,18,0.4)]">
              <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m0-12.728l.707.707m11.314 11.314l.707.707M12 8a4 4 0 100 8 4 4 0 000-8z" />
              </svg>
            </div>
            <span className="text-xl font-bold tracking-tight text-white flex items-center">
              Studio<span className="text-[#ff4f12] text-xs font-mono ml-1.5 px-1.5 py-0.5 rounded bg-[#ff4f12]/10 border border-[#ff4f12]/20">v2.0</span>
            </span>
          </div>
              ...
              <div className="w-full md:w-56 border-r border-white/5 bg-[#08080c]/50 p-4 flex flex-col justify-between hidden md:flex">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-2 px-2">
                    ...
                    <span className="text-sm font-bold text-white tracking-wide">Studio Engine</span>
                  </div>
                  {/* Nav list */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-400 max-w-xl mx-auto text-base">
              Stop switching tabs. Studio aggregates your entire web3 presence into a single, cohesive dashboard with responsive performance details.
            </p>
          </div>
            ...
            <div className="md:col-span-2 p-8 rounded-3xl border border-white/5 bg-[#0a0a0f]/60 backdrop-blur-sm relative overflow-hidden flex flex-col justify-between h-[380px] group hover:border-[#ff4f12]/30 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs leading-relaxed max-w-md">
                  Connect MetaMask, Phantom, Ledger, or simply track raw addresses. Studio builds a centralized index mapping to real-time RPC node pipelines.
                </p>
              </div>
              ...
              <div className="h-44 w-full relative flex items-center justify-center mt-4">
                <svg className="absolute inset-0 w-full h-full" viewBox="0 0 500 180">
                  {/* Glowing Lines */}
                  {[
                    { x1: 250, y1: 90, x2: 80, y2: 30 },
                    { x1: 250, y1: 90, x2: 120, y2: 150 },
                    { x1: 250, y1: 90, x2: 420, y2: 40 },
                    { x1: 250, y1: 90, x2: 380, y2: 140 }
                  ].map((line, idx) => (
                    <g key={idx}>
                      <line x1={line.x1} y1={line.y1} x2={line.x2} y2={line.y2} stroke="rgba(255, 79, 18, 0.15)" strokeWidth="1.5" />
                      <line x1={line.x1} y1={line.y1} x2={line.x2} y2={line.y2} stroke="#ff4f12" strokeWidth="1.5" className="animate-dash" />
                    </g>
                  ))}
                  
                  {/* Central Node */}
                  <circle cx="250" cy="90" r="32" fill="#ff4f12" className="opacity-15 animate-pulse" />
                  <circle cx="250" cy="90" r="20" fill="url(#orangeGradient)" stroke="#ff4f12" strokeWidth="1.5" />
                  <text x="250" y="93" fill="white" fontSize="10" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">STUDIO</text>

                  {/* Outer nodes */}
                  {[
                    { cx: 80, cy: 30, text: "MetaMask", logoColor: "#f6851b" },
                    { cx: 120, cy: 150, text: "Phantom", logoColor: "#ab9ff2" },
                    { cx: 420, cy: 40, text: "Ledger", logoColor: "#ffffff" },
                    { cx: 380, cy: 140, text: "Coinbase", logoColor: "#0052ff" }
                  ].map((node, idx) => (
                    <g key={idx}>
                      <circle cx={node.cx} cy={node.cy} r="22" fill="#0c0c12" stroke="rgba(255,255,255,0.08)" strokeWidth="1" />
                      <circle cx={node.cx} cy={node.cy} r="6" fill={node.logoColor} />
                      <text x={node.cx} y={node.cy + 30} fill="#94a3b8" fontSize="9" fontWeight="semibold" textAnchor="middle">{node.text}</text>
                    </g>
                  ))}
                </svg>
              </div>
            ...
            <div className="md:col-span-3 p-8 rounded-3xl border border-white/5 bg-[#0a0a0f]/60 backdrop-blur-sm relative overflow-hidden flex flex-col justify-between h-[360px] group hover:border-[#ff4f12]/30 transition-all duration-300">
              ...
              <div className="h-40 w-full relative flex items-center justify-center mt-4">
                <div className="relative w-28 h-28 flex items-center justify-center">
                  ...
                  {/* Pulsing glow dots */}
                  <div className="absolute top-1/2 left-0 w-2 h-2 rounded-full bg-emerald-400 animate-ping" />
              ...
              <div className="h-44 w-full relative flex items-center justify-center mt-2 perspective-1000">
                ...
                >
                  <div className="flex justify-between items-start">
                    <span className="text-xs font-bold font-mono tracking-widest text-[#ff4f12]">STUDIO PRESET</span>
          ...
          >
            ...
            <div className="w-full h-full rounded-[24px] overflow-hidden bg-[#030303] flex flex-col relative pt-5 p-3 text-left">
              ...
              <div className="flex justify-between items-center mb-4">
                <span className="text-[8px] font-bold text-[#ff4f12] font-mono">STUDIO MOBILE</span>
      ...
      <footer className="border-t border-white/5 bg-[#050508] py-16 px-6 relative z-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#ff5722] to-[#ff2b06] flex items-center justify-center">
                <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m0-12.728l.707.707m11.314 11.314l.707.707M12 8a4 4 0 100 8" />
                </svg>
              </div>
        ...
        <div className="max-w-6xl mx-auto pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-[10px] text-slate-500 font-mono">
            © 2026 Studio Inc. All rights reserved. Made for premium decentralized browsing experiences.
          </div>
          {/* Social Icons */}
